...
local function unpack_int(b) --pretty sure this unpacks the array
...
function update()
    for idx = 0, num_pins - 1 do
        ...
        gcs:send_text(MAV_SEVERITY_INFO,  "A" .. idx .. ": " .. unpack_int(data)) -- idx is the sensor number and the unpack_int is the unpacked data
    end
    return update, RUN_INTERVAL_MS
end

function init()
    num_pins = get_num_pins() -- this tells us how many pins its receiving data from
